...
export default function Converter() {
  ...
  return (
    <div className="min-h-screen bg-background" data-testid={`page-converter-${tool.id}`}>
      {/* SEO Meta Tags */}
      <title>{tool.name} - Free Online File Converter</title>
      <meta name="description" content={`Convert ${tool.fromFormat.toUpperCase()} to ${tool.toFormat.toUpperCase()} online for free. ${tool.description}. Fast, secure, no registration required.`} />
      <meta name="keywords" content={`${tool.fromFormat} to ${tool.toFormat}, ${tool.name.toLowerCase()}, file converter, online converter, free converter`} />
      <meta property="og:title" content={`${tool.name} - Free Online Converter`} />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3 order-1 lg:order-2">
            ...
            <Card className="mb-8" data-testid="card-tool-header">
              <CardHeader>
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <CardTitle className="text-2xl" data-testid="text-tool-title">
                      {tool.name} Converter
                    </CardTitle>
              ...
              <CardContent className="p-6">
                ...
                <ol className="list-decimal list-inside space-y-2 text-sm text-muted-foreground">
                  <li data-testid="text-instruction-1">
                    Upload your {tool.fromFormat.toUpperCase()} file using the drag & drop area or click "Choose Files"
                  </li>
                  <li data-testid="text-instruction-2">
                    Adjust conversion settings if needed (quality, compression, etc.)
                  </li>
                  <li data-testid="text-instruction-3">
                    Click "Convert Files" and wait for the conversion to complete
                  </li>
                  <li data-testid="text-instruction-4">
                    Download your converted {tool.toFormat.toUpperCase()} file instantly
                  </li>
                </ol>
              </CardContent>
            </Card>
            ...
            <FileUploadZone 
              ...
              acceptedFileTypes={[`.${tool.fromFormat}`]}
            />
            ...
            <Card className="mb-8" data-testid="card-tool-details">
              <CardContent className="p-6">
                <h2 className="text-lg font-semibold mb-4" data-testid="text-about-tool">
                  About {tool.name} Conversion
                </h2>
                <div className="prose text-sm text-muted-foreground max-w-none">
                  <p data-testid="text-tool-detail-1">
                    Our {tool.name.toLowerCase()} converter provides fast, secure, and high-quality file conversion 
                    from {tool.fromFormat.toUpperCase()} to {tool.toFormat.toUpperCase()} format.
                  </p>
                  <p data-testid="text-tool-detail-2">
                    The conversion process is performed entirely in your browser or on our secure servers, 
                    ensuring your files remain private and are automatically deleted after conversion.
                  </p>
                  <p data-testid="text-tool-detail-3">
                    No software installation required - simply upload your files and download the converted results 
                    in seconds.
                  </p>
                </div>
              </CardContent>
